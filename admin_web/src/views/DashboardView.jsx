  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* Range Toggle Group */}
        <div className="inline-flex rounded-xl border border-border bg-muted/80 p-1 shadow-sm shrink-0 self-start sm:self-center">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {/* KPI 1: Active Fleet */}
        <Card className="border border-border bg-card p-6 shadow-sm rounded-2xl transition-all hover:shadow-md hover:-translate-y-0.5 duration-200">
          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">Active Fleet</span>
        ...
        <Card className="border border-border bg-card p-6 shadow-sm rounded-2xl transition-all hover:shadow-md hover:-translate-y-0.5 duration-200">
          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-muted-foreground uppercase tracking-wider">Total Donated Today</span>
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 text-primary">
